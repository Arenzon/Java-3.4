package ru.netology.manager.ru.netology.manager.ru.netology.manager;
...
public class MoviesManagerTest {
    private MoviesManagerTest manager = new MoviesManagerTest();
    PosterMovies first = new PosterMovies(1, "Золушка", "Сказки");
    PosterMovies second = new PosterMovies(2, "Тихий Дон", "Драма");
    PosterMovies third = new PosterMovies(3, "Аленький цветочек", "Мультфильм");
    PosterMovies fourth = new PosterMovies(4, "Жесть", "Фантастика");
    PosterMovies fifth = new PosterMovies(5, "Близнец", "Боевик");
